...
public class ImageLoaderUtil{
	...
	private static void initLoader(Context context) {
		...
		.showImageForEmptyUri(R.drawable.app_icon).cacheInMemory()
		.cacheOnDisc().imageScaleType(ImageScaleType.POWER_OF_2)
		.displayer(new RoundedBitmapDisplayer(0xff424242, 20)).build();
	...
	public static void displayImage(String url,ImageView imageView,Context context,DisplayImageOptions options,ImageLoadingListener imageLoadingListener){
