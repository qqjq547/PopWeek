...
{
	public static final String get_regions_with_businesses="http://api.dianping.com/v1/metadata/get_regions_with_businesses";
	public static final String get_categories_with_businesses="http://api.dianping.com/v1/metadata/get_categories_with_businesses";
	public static final String find_businesses="http://api.dianping.com/v1/business/find_businesses";
	public static final String get_daily_new_id_list="http://api.dianping.com/v1/deal/get_daily_new_id_list";
	public static final String get_batch_deals_by_id="http://api.dianping.com/v1/deal/get_batch_deals_by_id";
	public static final String find_deals="http://api.dianping.com/v1/deal/find_deals";
	public static final String find_coupons="http://api.dianping.com/v1/coupon/find_coupons";
	public static final String find_businesses_with_reservations="http://api.dianping.com/v1/reservation/find_businesses_with_reservations";
    ...
    public static String getQueryString(String appKey, String secret, Map<String, String> paramMap)
    {
        ...
        Log.i("hjq", "queryString:"+queryString);
        return queryString;
    }
