...
import com.hjq.adapter.TextAdapter;
...
public class ViewRight extends RelativeLayout implements ViewBaseAction{
	...
	private void init(Context context) {
		mContext = context;
		items=getResources().getStringArray(R.array.sort_type);
		itemsVaule=new String[items.length];
		for (int i = 0; i < items.length; i++) {
			itemsVaule[i]=String.valueOf(i+1);
		}
